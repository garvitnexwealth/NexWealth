      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <div className="card p-6">
          ...
          <div className="mt-4 space-y-3">
            {["Groww - Indian Stocks", "INDmoney - US Stocks", "ICICI - Savings"].map((item) => (
              <div key={item} className="flex items-center justify-between rounded-xl bg-ink-850/70 p-3 text-sm">
                <span>{item}</span>
        ...
        <div className="card p-6">
          ...
          <div className="mt-4 flex gap-3">
            <button className="rounded-full bg-teal-400 px-4 py-2 text-xs font-semibold text-ink-950">INR</button>
            <button className="rounded-full bg-ink-850 px-4 py-2 text-xs text-slate-200">USD</button>
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="card p-6">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-300">
            ...
            <div className="rounded-xl bg-ink-850/70 p-3">Holding snapshots</div>
            <div className="rounded-xl bg-ink-850/70 p-3">Real estate valuations</div>
          </div>
        </div>
      </section>
    </div>
